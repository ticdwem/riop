...
<ul class="car" id="c"> 	
		...
		<li class="car-sec"><img src="images/servicio5.png" width="100%" height="125px"><p class="text-center">Podemos ofrecerle una línea de crédito de acuerdo a sus necesidades.</p></li>
		<li class="car-sec"><img src="images/periferico-logo.png" width="75%" height="125px"><p class="text-center">Cerca de la estacion PERIFERICO ORIENTE - CMDX</p></li>
